...
'''
Title: unioncount_reg_weighmet.py
Date: 20191012
...
Description:
	This script iterates over a positions file generated by bedtools unionbedg with "meth/total" calls per position
	(unioncount file) and a corresponding regions file, to give the weighted average methylation (Schultz et al. 2013)
...
Usage:
	unioncount_reg_weighmet.py [REGIONS] [POSITIONS] [INDEX] [FOUT]
eg. unioncount_reg_weighmet.py regions.bed positions.bed index.txt reg_meth.bed
'''

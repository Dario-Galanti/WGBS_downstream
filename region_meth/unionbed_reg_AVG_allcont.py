...
## Define input files
fin_CpG = str("CpG_" + sys.argv[1])
fin_CHG = str("CHG_" + sys.argv[1])
fin_CHH = str("CHH_" + sys.argv[1])
...
sns.distplot(CpG_AV, color="#CD5B45", label="CpG", **kwargs, bins=bins, kde=False)	# Old col: "dodgerblue"
